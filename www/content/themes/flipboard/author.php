...
<section id="base">
	<?php the_post(); ?>          
		<div class="entry-content-author">
			<h2 class="page-title"><?php printf( __( 'Author Archives: <span class="vcard">%s</span>', 'flipboard' ), $authordata->display_name ) ?></h2>
			<?php $authordesc = $authordata->user_description; if ( !empty($authordesc) ) echo apply_filters( 'archive_meta', $authordesc ); ?>
		</div>
	<?php rewind_posts(); ?> 
	<div class="primary">
