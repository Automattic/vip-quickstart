...
sudo -u www-data wp --path=/srv/www/wp pmc-site setup --domain=varietylatino.qa.pmc.com --title="QA Variety Latino" --home=http://qa.varietylatino.com --theme=vip/pmc-variety-latino
