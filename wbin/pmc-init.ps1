...
foreach ( $theme in @( 'bgr', 'pmc-deadline', 'pmc-plugins', 'pmc-variety-2014', 'pmc-variety-latino', 'pmc-tvline-2014', 'pmc-hollywoodlife', 'pmc-awardsline', 'pmc-411', 'pmc-movieline', 'pmc-tvline-mobile', 'pmc-movieline-mobile' ) ) {
